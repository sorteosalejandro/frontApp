  ...
  return (
    <div className="flex flex-col w-full mx-auto justify-center items-center border-b border-gray-300 p-8 pb-12 md:w-2/3">
      ...
      <div className="flex flex-col text-center mb-6">
        <p className="text-5xl md:text-4xl font-bebas font-bold text-black mb-12">
          Rifas Alejandro Medina
        </p>
        <p className="text-5xl md:text-6xl uppercase font-bebas font-bold text-orange-600">
          {name}
        </p>
        <p className="text-xl md:text-2xl uppercase font-bebas font-semibold text-gray-800 mb-2">
          {description}
        </p>
        <p className="text-xl font-anton uppercase font-semibold text-gray-800">
