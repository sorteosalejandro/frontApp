...
function HeaderPage({ name, description, images, ticketPrice }: Props) {
  return (
    <div className="flex flex-col w-full mx-auto justify-center items-center border-b border-gray-500 p-8 pb-12 md:w-2/3">
      ...
      <div className="flex flex-col text-center mb-6">
        ...
        <p className="text-xl md:text-2xl uppercase font-bebas font-semibold text-gray-200 mb-2">
          {description}
        </p>
        <p className="text-xl font-anton uppercase font-semibold text-gray-200">
